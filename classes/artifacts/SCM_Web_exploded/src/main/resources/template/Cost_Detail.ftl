				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu" data-widget="tree">
						...
						<li class="active treeview menu-open">
							...
							<ul class="treeview-menu">
								<li class="active"><a href="pages/widgets.html"><i class="fa fa-circle-o"></i> 成本管理</a></li>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="/cost/queryCost">成本管理</a></li>
						<li class="active">成本信息详情</li>
					</ol>
				</section>
											...
											<form class="form-horizontal">
												<div class="box-body">
													<div class="form-group col-md-6">
														<label class="col-sm-4 control-label">入库ID</label>
														<div class="col-sm-8">
															<input type="text" class="form-control" name="id" value="${inList.id}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="in_timestamp" value="${inList.in_timestamp}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
                                                            <input type="text" class="form-control" name="factory_name" value="${inList.factory_name!""}" readonly="readonly">
														</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="repository_name" value="${inList.repository_name!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="in_date" value="${inList.in_date!""}" readonly="readonly">
														</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="tel" class="form-control" name="product_main_code" value="${inList.product_main_code!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_code" value="${inList.product_code!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_color" value="${inList.product_color!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_size" value="${inList.product_size!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_density" value="${inList.product_density!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_makou" value="${inList.product_makou!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_mashu" value="${inList.product_mashu!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_price" value="${inList.product_price!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="total_price" value="${inList.total_price!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
                                                            <input type="text" class="form-control" name="is_callback" value="<#if inList.is_callback==1>已退货<#else >未退货</#if>" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="comment" value="${inList.comment!""}" readonly="readonly">
														</div>
													</div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" name="is_cost_complete" value="<#if cost.is_cost_complete == 1>已完结<#else >未完结</#if>" readonly="readonly">
                                                        </div>
                                                    </div>
