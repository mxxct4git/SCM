					...
					<ul class="sidebar-menu" data-widget="tree">
						...
						<li class="active treeview menu-open">
							...
							<ul class="treeview-menu">
								...
								<li class="active"><a href=""><i class="fa fa-circle-o"></i> 库存管理</a></li>
						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-body">
									<div class="row">
										<div class="col-md-8">
											<form class="form-horizontal" action="/storage/queryStorage" method="post">
												<div class="box-body">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="col-sm-4 control-label">数量下限</label>

                                                        <div class="col-sm-8">
                                                            <input type="number" class="form-control" name="quantity_lower" placeholder="数量下限">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="number" class="form-control" name="quantity_upper" placeholder="数量上限">
                                                        </div>
                                                    </div>
										...
										<div class="col-md-4">
											<div class="box-body">
												...
												<a href="#" class="btn btn-info pull-right col-md-5 col-sm-5 col-xs-5">资源调配</a>
											</div>
											<#--<div class="box-body">
												<a href="#" class="btn btn-primary col-md-12 col-sm-12 col-xs-12">资源调配</a>
											</div>-->
										</div>
                                        </form>
										<!-- /.col -->
								...
								<div class="box-body table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tr>
											...
											<td>${item.product_density!""}</td>
											<td>${item.product_makou!""}</td>
											<td>${item.quantity!""}</td>
											<td style="text-align: center;"><a href=""><i class="fa fa-plus"></i></a></td>
											<td style="text-align: center;"><a href=""><i class="fa fa-minus"></i></a></td>
										</tr>
                                        </#list>
										</tfoot>
									</table>
