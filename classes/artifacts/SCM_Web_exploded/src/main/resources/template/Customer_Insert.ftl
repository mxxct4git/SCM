            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="Customer_Management.ftl"><i class="fa fa-circle-o"></i> 客户管理</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/customer/queryCustomer">客户管理</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="/customer/insert" method="post">
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                <a href="/customer/queryCustomer" class="btn btn-default">取消</a>
