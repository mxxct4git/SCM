					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text">主工厂</span>
									<span class="info-box-number">主工厂1</span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text">分工厂</span>
									<span class="info-box-number">共10<small>家</small></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-body">
									<div class="row">
										<div class="col-md-8">
											<form class="form-horizontal" action="/factory/queryFactory" method="post">
												<div class="box-body">
													...
													<div class="form-group col-md-6">
														<label class="col-sm-4 control-label">工厂负责人</label>
													...
													<div class="form-group col-md-6">
														<label class="col-sm-4 control-label">工厂类型</label>
								...
								<div class="box-body table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tr>
											...
											<td>
                                                <#if item.is_main_factory?exists>
                                                    <#if item.is_main_factory == 1>
                                                    自家厂
                                                    <#elseif item.is_main_factory == 2>
                                                    主工厂
                                                    <#elseif item.is_main_factory == 3>
                                                    分工厂
                                                    </#if>
                                                <#else>
                                                    未配置
											...
											<td>${item.comment!""}</td>
											<td style="text-align: center;"><a href="/factory/editFactory?id=${item.id}"><i class="fa fa-edit"></i></a></td>
											<td style="text-align: center;"><a href="javascript:deleteById('${item.id}')"><i class="fa fa-remove"></i></a></td>
											<td style="text-align: center;">
                                                <#if item.is_main_factory == 2>
                                                    <a href="javascript:cancelSetMainFac('${item.id}')"><i class="fa fa-rebel"></i>取消主工厂</a>
                                                    <#elseif  item.is_main_factory == 3>
                                                    <a href="javascript:setMainFac('${item.id}')"><i class="fa fa-anchor"></i>设为主工厂</a>
                                                </#if>
											</td>
										</tr>
                                        </#list>
		...
		<script>
            ...
            function deleteById(id) {
                if (confirm("确定删除该条信息吗？")) {
                    //删除药品
                    location.href = "/factory/delete?id=" + id;
                }
            };
            function cancelSetMainFac(id) {
                if (confirm("确定取消该厂为主工厂吗？")) {
                    //删除药品
                    location.href = "/factory/cancelSetMainFac?id=" + id;
                }
            };
            function setMainFac(id) {
                if (confirm("确定设置该厂为主工厂吗？")) {
                    //删除药品
                    location.href = "/factory/setMainFac?id=" + id;
                }
            };
		</script>
		<!-- ./wrapper -->
