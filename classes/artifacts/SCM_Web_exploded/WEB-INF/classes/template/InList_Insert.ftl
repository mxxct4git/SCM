							...
							<div class="box box-info">
								<div class="box-body">
									<div class="row">
										<div class="col-md-8">
											<!--startprint-->
											<form class="form-horizontal" action="/inList/insert" method="post">
												<div class="box-body">
													<div class="form-group col-md-6">
														<label class="col-sm-4 control-label">入库单号</label>
														<div class="col-sm-8">
															<input type="text" class="form-control" name="in_timestamp" value="${timeStamp}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control pull-right" id="datepicker" name="in_date" placeholder="yyyy-mm-dd" data-date-format='yyyy-mm-dd'>
														</div>
												...
												<div class="box-footer">
													<a href="/inList/queryInList" class="btn btn-default">返回</a>
