						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-body">
									<div class="row">
										<div class="col-md-8">
											<form class="form-horizontal" action="/repository/queryRepository" method="post">
												<div class="box-body">
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="manager" placeholder="仓库负责人">
														</div>
										...
										<div class="col-md-4">
                                            <div class="box-body">
                                                ...
                                                <a href="/repository/insertRepository"
								...
								<div class="box-body table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tr>
											...
											<td>${item.volume!""}</td>
											<td>${item.comment!""}</td>
											<td style="text-align: center;"><a href="/repository/editRepository?id=${item.id}"><i class="fa fa-edit"></i></a></td>
		...
		<script>
            ...
            function deleteById(id) {
                if (confirm("确定删除该条信息吗？")) {
                    //删除药品
                    location.href = "/repository/delete?id=" + id;
                }
            }
		</script>
		<!-- ./wrapper -->
