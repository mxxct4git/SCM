                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    var id = d.id;
                                    var name = d.name;
                                    if(id == ${deploy.source_factory_id}){
                                        $("#fac_type1").append("<option value="+id+" selected>" + name + "</option>");
                                    }else {
                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    var id = d.id;
                                    var name = d.name;
                                    if(id == ${deploy.source_repository_id}){
                                        $("#rep_type1").append("<option value="+id+" selected>" + name + "</option>");
                                    }else{
                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    ...
                                    if(main_code == ${deploy.source_product_main_code}){
                                        $("#main_code_type1").append("<option value="+main_code+" selected>" + main_code + "</option>");
                                    }else{
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    var code = d.code;
                                    if(code == ${deploy.source_product_code}){
                                        $("#code_type1").append("<option value="+code+" selected>" + code + "</option>");
                                    }else{
                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    var id = d.id;
                                    var name = d.name;
                                    if(id == ${deploy.aim_factory_id}){
                                        $("#fac_type2").append("<option value="+id+" selected>" + name + "</option>");
                                    }else{
                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    var id = d.id;
                                    var name = d.name;
                                    if(id == ${deploy.aim_repository_id}){
                                        $("#rep_type2").append("<option value="+id+" selected>" + name + "</option>");
                                    }else{
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    var main_code = d.main_code;
                                    if(main_code == ${deploy.aim_product_main_code}){
                                        $("#main_code_type2").append("<option value="+main_code+" selected>" + main_code + "</option>");
                                    }else{
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        ...
                        $(data).each(
                                function(i, d) {
                                    var code = d.code;
                                    if(code == ${deploy.aim_product_code}){
                                        $("#code_type2").append("<option value="+code+" selected>" + code + "</option>");
                                    }else{
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="row">
										<div class="col-md-10">
											<!--startprint-->
											<form class="form-horizontal" action="/deploy/update" method="post">
												<div class="box-body">
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control pull-right" value="${deploy.deploy_date}" id="datepicker" placeholder="yyyy-mm-dd" data-date-format='yyyy-mm-dd'>
														</div>
													</div>
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" value="${deploy.product_color!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" value="${deploy.product_size!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" value="${deploy.product_density!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" value="${deploy.product_makou!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" value="${deploy.product_mashu!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="number" class="form-control" value="${deploy.deploy_quantity!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-8">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" value="${deploy.comment!""}">
														</div>
													</div>
