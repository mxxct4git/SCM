  ...
  <![endif]-->
	...
	<body class="hold-transition skin-blue sidebar-mini">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number">10<small>单</small></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-body">
									<div class="row">
										<div class="col-md-8">
											<form class="form-horizontal" action="/outList/queryOutList" method="post">
												<div class="box-body">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control pull-right" name="out_date" id="datepicker" placeholder="yyyy-mm-dd" data-date-format='yyyy-mm-dd'>
                                                        </div>
                                                    </div>
										...
										<div class="col-md-4">
											<div class="box-body">
												...
												<a href="/outList/insertOutList" class="btn btn-info pull-right col-md-5 col-sm-5 col-xs-5">添加</a>
											</div>
											<!-- <div class="box-body">
							...
							<div class="box box-primary">
								...
								<div class="box-body table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
                                        <#list outLists as item>
										<tr>
											<td>${item.id}</td>
											<td>${item.out_timestamp!""}</td>
											...
											<td style="text-align: center;"><a href="javascript:callbackById('${item.id}')"><i class="fa fa-reply"></i></a></td>
											<td style="text-align: center;"><a href="/outList/detailOutList?id=${item.id}" target="_blank"><i class="fa fa-file-o"></i></a></td>
											<td style="text-align: center;"><a href="javascript:deleteById('${item.out_timestamp}')"><i class="fa fa-remove"></i></a></td>
										</tr>
                                        </#list>
										</tfoot>
									</table>
		...
		<script>
            ...
            function deleteById(out_timestamp) {
                if (confirm("确定删除该条信息吗？")) {
                    location.href = "/outList/delete?out_timestamp=" + out_timestamp;
                }
            };
            function callbackById(id) {
                if (confirm("确定要退货吗？")) {
                    location.href = "/outList/callback?id=" + id;
                }
            }
		</script>
		<script>
