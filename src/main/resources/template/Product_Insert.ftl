			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="/product/queryProduct">商品管理</a></li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="box box-info">
								...
								<!-- /.box-header -->
								<!-- form start -->
								<form class="form-horizontal" action="/product/insert" method="post">
									<div class="box-body">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">商品主编码</label>
									...
									<div class="box-footer">
                                        <a href="/product/queryProduct" class="btn btn-default">取消</a>
