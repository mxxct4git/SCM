		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-pie-chart"></i>其他数据</li>
						<li><a href="/user/queryUser">用户管理</a></li>
								...
								<form class="form-horizontal" action="/user/update" method="post">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" placeholder="用户权限">
											</div>
										</div>
									</div>
									<!-- /.box-body -->
									<div class="box-footer">
                                        <a href="/user/queryUser" class="btn btn-default">取消</a>
