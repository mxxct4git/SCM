					...
					<ul class="sidebar-menu" data-widget="tree">
						...
						<li class="active treeview menu-open">
							...
							<ul class="treeview-menu">
								...
								<li class="active"><a href="Product_Management.html"><i class="fa fa-circle-o"></i> 商品管理</a></li>
						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-body">
									<div class="row">
										<div class="col-md-8">
											<form class="form-horizontal" action="/product/queryProduct" method="post">
												<div class="box-body">
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="main_code" placeholder="商品主编码">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="code" placeholder="商品编码">
														</div>
													</div>
												</div>
												<!-- /.box-body -->
								...
								<div class="box-body table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tr>
											...
											<td>${item.name!""}</td>
											<td>${item.comment!""}</td>
											<td style="text-align: center;"><a href="/product/editProduct?id=${item.id}"><i class="fa fa-edit"></i></a></td>
											<td style="text-align: center;"><a href="javascript:deleteById('${item.id}')"><i class="fa fa-remove"></i></a></td>
											<td style="text-align: center;"><a href="#"><i class="fa fa-cog"></i></a></td>
										</tr>
                                        </#list>
										</tfoot>
									</table>
