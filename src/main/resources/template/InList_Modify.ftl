...
<html>
  ...
  <![endif]-->
        ...
        <script>
            $(function() {
                $("#rep_type").empty();
                var rep_id = ${inList.repository_id};
                $.ajax({
                    async : true,
                    dataType : "json",
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="row">
										<div class="col-md-8">
											<!--startprint-->
											<form class="form-horizontal" action="/inList/update" method="post">
												<div class="box-body">
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control pull-right" id="datepicker" name="in_date" value="${inList.in_date!""}" data-date-format='yyyy-mm-dd'>
														</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="tel" class="form-control" name="product_main_code" value="${inList.product_main_code!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_code" value="${inList.product_code!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_color" value="${inList.product_color!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_size" value="${inList.product_size!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_density" value="${inList.product_density!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="product_makou" value="${inList.product_makou!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="mashu" name="product_mashu" value="${inList.product_mashu!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="price" name="product_price" value="${inList.product_price!""}">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="total" name="total_price" value="${inList.total_price!""}" readonly="readonly">
														</div>
													</div>
													...
													<div class="form-group col-md-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" name="comment" value="${inList.comment!""}">
														</div>
													</div>
